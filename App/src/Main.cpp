...
int main(int argc, char** argv) {
	...
	if (argc < 6) {
		...
		LOG_ERROR("Usage: {} <mesh_file> <gltf_file> <diffuse_texture_file> <normal_texture_file> <animation_file>", argv[0]);
		return -1;
	}
	...
	if (!MeshData_SaveToGltfFile(meshData, argv[2], argv[3], argv[4], argv[5])) {
